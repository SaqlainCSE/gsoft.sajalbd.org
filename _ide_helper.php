...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Dyrynda\Database\LaravelEfficientUuidServiceProvider::register()
         * @param \Illuminate\Support\Fluent $column
         * @static 
         */ 
        public static function typeEfficientUuid($column)
        {
                        return \Illuminate\Database\Grammar::typeEfficientUuid($column);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function efficientUuid($column)
        {
                        return \Illuminate\Database\Schema\Blueprint::efficientUuid($column);
        }
