            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('booking.update', $booking->id) }}" id="order-form" role="form"
        ...
        <tbody id="template">
            <tr id="row_id_{index}">
                ...
                <td style="padding: 2px 2px 3px;">
                    <input class="form-control st_dia_price" name="st_dia_price[]" value="{st_dia_price}"
                        {st_dia_price_required} onkeyup="calculateUnitPrice('row_id_{index}')" />
                </td>
                <td style="padding: 2px 2px 3px;">
                    <input class="form-control unit_price" name="unit_price[]" value="{unit_price}" required="true"
                        onkeyup="calculateUnitPrice('row_id_{index}')" />
                </td>
                <td style="padding: 2px 2px 3px;">
                    <input class="form-control wage" data-wage="{wage}" data-wage-type="{wage_type}" name="wage[]"
                        value="" required="true" onkeyup="handleChangeWage('row_id_{index}')" />
                </td>
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex">
                    ...
                    <button onclick="removePaymentRow({index})" type="button"
                        class="btn btn-danger glyphicon glyphicon-remove row-remove" style="margin-left: 5px;">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
            </div>
