<x-admin-layout :title="__('Create Customer Category')">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title ">{{ __('Create Customer Category') }}</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('customer-categories.store') }}"  role="form" enctype="multipart/form-data">
                                @csrf
