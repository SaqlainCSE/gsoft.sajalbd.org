<x-admin-layout :title="__('Update Expense')">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <!-- App Search-->
                            <a href="{{ route('expenses.index') }}" class="btn btn-outline-primary waves-effect waves-light">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title ">{{ __('Update  Expense') }}</h4>
                        </div>
                        <div class="card-body">
