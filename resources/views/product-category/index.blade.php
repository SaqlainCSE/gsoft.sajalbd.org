<x-admin-layout :title="__('Product Category')">
                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                           <a href="{{ route('product-categories.create') }}" class="btn btn-soft-success waves-effect waves-light">
                    ...
                    { "data": "action",
                        ...
                        'render': function ( data, type, row, meta ) {
                            return '<a class="btn btn-sm btn-success" \
                                    href="{{ route('product-categories.index') }}/'+row.id+'/edit"><i \
