...
<div class="mb-3 row">
    ...
    <div class="col-md-9">
        {{ Form::text('name', $saleType->name, ['class' => 'form-control' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'Name']) }}
    ...
    <div class="col-md-9">
        <div class="form-check form-switch form-switch-lg" dir="ltr">
            <input name="status" class="form-check-input @if ($errors->has('status')) ? ' is-invalid' : '' @endif" type="checkbox" id="Switchsts"
                value="1" @if (isset($saleType->status) ? $saleType->status : old('status')) checked @endif>
