<x-admin-layout :title="__('Create Setting')">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <!-- App Search-->
                            <a href="{{ route('settings.index') }}" class="btn btn-outline-primary waves-effect waves-light">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title ">{{ __('Create Setting') }}</h4>
                        </div>
                        <div class="card-body">
