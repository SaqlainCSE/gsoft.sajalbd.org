            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('tc.index') }}"  role="form" enctype="multipart/form-data">
                                @csrf
                                <div class="col-12 mb-4">
                                    {!! Form::textarea('description', setting('terms'), ['id'=>'template', 'required' => true, 'class' => 'form-control', 'placeholder' => 'Terms & Condition']) !!}
                                </div>
                                <div class="col-12">
