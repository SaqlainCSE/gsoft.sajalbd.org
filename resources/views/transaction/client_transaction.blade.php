                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right" style="display: flex">
                            <a href="{{ route('client_due') }}/{{ $client->id }}/print"
                                class="btn btn-soft-success waves-effect waves-light" target="_blank">
                                {{ __('PRINT') }}
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    <div class="page card" orientation="portrait" size="A4" pages="1"
                        style="padding-top: 20px;margin:0 auto;color: #000; width: 100%">
                            ...
                            <thead>
                                <tr>
                                    <td class="text-center"
                                        style="width:52px;font-size:12px;font-weight: bold;font-family: math;">SL:</td>
                                    <td class="text-center"
                                        style="font-size:12px;font-weight: bold;font-family: math;width: 80px;">Date
                                    </td>
                                    <td class="text-center"
                                        style="font-size:12px;font-weight: bold;font-family: math;width: 80px;">Memo No
                                    </td>
                                    <td class="text-center" style="font-size:12px;font-weight: bold;font-family: math;">
                                        Description</td>
                                    <td class="text-center"
                                        style="width:100px;font-size:12px;font-weight: bold;font-family: math;">Bill
                                    </td>
                                    <td class="text-center"
                                        style="width:100px;font-size:12px;font-weight: bold;font-family: math;">Pay</td>
                                </tr>
                            </thead>
                            <tbody>
                                @php
                                ...
                                @if ($transactions)
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            <td class="text-center"
                                                style="width:52px;font-size:12px;font-family: math;">
                                                {{ $i }}
                                            </td>
                                            ...
                                            <td style="width:59px;font-size:12px;font-family: math;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"
                                        style="width:59px;font-size:12px;font-family: math;font-weight: bold;">Total
                                        Due:</td>
