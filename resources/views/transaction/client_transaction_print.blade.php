...
<body onload="window.print()" onafterprint="window.close()">
    ...
    <div class="page card" orientation="portrait" size="A4" pages="1"
        ...
        <table class="table-fw table-border">
            <thead>
                <tr>
                    <td class="text-center" style="width:52px;font-size:12px;font-weight: bold;font-family: math;">SL:
                    </td>
                    <td class="text-center" style="font-size:12px;font-weight: bold;font-family: math;width: 80px;">Date
                    </td>
                    <td class="text-center" style="font-size:12px;font-weight: bold;font-family: math;width: 80px;">Memo
                        No</td>
                    <td class="text-center" style="font-size:12px;font-weight: bold;font-family: math;">Description</td>
                    <td class="text-center" style="width:100px;font-size:12px;font-weight: bold;font-family: math;">Bill
                    </td>
                    <td class="text-center" style="width:100px;font-size:12px;font-weight: bold;font-family: math;">Pay
                    </td>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end" style="width:59px;font-size:12px;font-family: math;font-weight: bold;">Total
                        Due:</td>
