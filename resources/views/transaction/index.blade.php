                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                           <a href="{{ route('transactions.create') }}" class="btn btn-soft-success waves-effect waves-light">
                                {{ __('Add Due') }}
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    ...
                                    <th>Pay</th>
                                    {{-- <th>Advance</th> --}}
                                    @canany(['Edit Due Transaction', 'Delete Due Transaction'])
                                        <th>Action</th>    
                                    @endcanany
                                </tr>
                                </thead>
                    ...
                    @canany(['Edit Due Transaction', 'Delete Due Transaction'])
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            @can('Edit Due Transaction')
                                html += " <a href='{{ route('transactions.index') }}/" + row.id + "/edit' class='btn-sm'><i class='fa fa-pen'></i></a>"; 
                            @endcan
                            @can('Delete Due Transaction')
                                html += `<span role="button" data-route="{{ route('transactions.index') }}/` + row.id + `" class="text-danger btn-sm" onClick="window.onClickDeleteHandeler(this)"><i class="fa fa-fw fa-trash"></i></span>`; 
                            @endcan
                            return html;
                        }
                    }  
