                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="mb-3 mb-md-0">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('transactions.index') }}">{{ __('Transaction') }}</a></li>
                                <li class="breadcrumb-item active">{{ $transaction->name ?? 'Show Transaction' }}</li>
                            </ol>
                        </div>
                        <div class="page-title-right text-right">
                            <a href="{{ route('transactions.index') }}" class="d-none d-sm-inline-block btn btn-outline-primary waves-effect waves-light mb-2 mb-md-0">
